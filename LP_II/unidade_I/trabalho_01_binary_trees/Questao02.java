...
public class Questao02 {
	...
	public static double mediaRecursiva(ArrayList<Double> valores, int index, int quant, double soma) {
	...
	public static void main(String[] args) {
		...
		System.out.println("Questao 02 - Media por recursao");
		...
		double media = mediaRecursiva(valores, valores.size()-1, valores.size(), 0);
